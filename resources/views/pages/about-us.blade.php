...
<!-- Mirrored from theme.bitspecksolutions.com/html-template/bitpro/bitinstitute/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 03:17:15 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="client_feedback">
                                <div class="fdbck_main">
                                    <div class="feedback_txt">
                                        <p>
                                            Lorem Ipsum is simply dummy text of the printing text of the printing and typesetting and typesetting industry. orem Ipsum has been the industry's standard dummy text ever since the 1500s.
                                        </p>
                            ...
                            <div class="client">
                                <div class="client_main_img">
                                    <div class="client_img">
                                        <img src="{{url('theme/images/team1.png')}}" class="img-responsive" alt="">
                                    </div>
                                </div>
                                <div class="client_main_img">
                                    <div class="client_img">
                                        <img src="{{url('theme/images/team2.png')}}" class="img-responsive" alt="">
                                    </div>
                                </div>
                                <div class="client_main_img">
                                    <div class="client_img">
                                        <img src="{{url('theme/images/team_3.jpg')}}" class="img-responsive" alt="">
                                    </div>
                                </div>
                                <div class="client_main_img">
                                    <div class="client_img">
                                        <img src="{{url('theme/images/team_2.jpg')}}" class="img-responsive" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container text-center">
                <div class="row">
                        ...
                        <div class="count-in">
                            <div class="counter-text">
                                <div class="cointer-img">
                                    <img src="{{url('theme/images/student.png')}}" alt="img" class="img-responsive">
                                </div>
                                <h4>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mid-2">
                        <div class="count-in">
                            <div class="cointer-img">
                                <img src="{{url('theme/images/troffi.png')}}" alt="img" class="img-responsive">
                            </div>
                            <div class="counter-text">
                                <h4>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mid-3">
                        <div class="count-in">
                            <div class="cointer-img">
                                <img src="{{url('theme/images/drawing.png')}}" alt="img" class="img-responsive">
                            </div>
                ...
                <div class="row">
                    ...
                    <h4 class="footer-title">OUR SITEMAP</h4>
                        <ul class="sitemap-widget">
                            ...
                            <li><a href="{{url('courses')}}"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i>Courses</a></li>
                           
                           
                            <li><a href="{{url('event-details')}}"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i>Events Details</a></li>
                            
                            <li><a href="{{url('contact')}}"><i class="fa fa-angle-right"

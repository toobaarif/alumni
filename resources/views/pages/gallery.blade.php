...
<body data-spy="scroll" data-target="#bs-example-navbar-collapse-1">
    ...
    <header id="home">
                    ...
                    <div class="col-sm-6 ">
                        <div class="top-info">
                            ...
                            <ul class="top-bar-text">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-phone icon-color" aria-hidden="true"></i> +88 05656269526 </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-envelope icon-color" aria-hidden="true"></i> info@bitinstitute.edu </a>
                                </li>
                            </ul>
                            <!-- /.head info -->
                        </div>
                        ...
                        <div class="col-sm-2 pl-0">
                            <div class="navbar-header">
                                ...
                                <a href="index.html" class="logo">
                                    <img src="{{url('theme/images/logo.png')}} class="img-responsive" alt="">
                                </a>
                            </div>
                        </div>
        ...
        <nav id='cssmenu' class="hidden-sm hidden-lg hidden-md">
            <div class="logo">
                <a href="index.html" class="logo">
                    <img src="images/logo.html" class="img-responsive" alt="">
                </a>
            </div>

...
<!-- Mirrored from theme.bitspecksolutions.com/html-template/bitpro/bitinstitute/notice.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 03:17:15 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <title>Bit institute-Notice</title>
    <!-- Favicon -->
  ...
  <body data-spy="scroll" data-target="#bs-example-navbar-collapse-1">
    ...
    <!-- Here is the event banner part start -->
    <section id="myabout" class="about-details">
      <div class="about-text"><h3>Notice details</h3></div>
    </section>

    <!-- Here is the event part End -->

    <!-- Here is the notice-inner part Start -->

    <section id="blog-detail-page" class="blog">
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12">
            <div class="heading-border"><h3>notice</h3></div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="blogpost_details">
              <img
                src="assets/images/blog-details-image.jpg"
              ...
              <div class="blogpost_description">
                <div class="blg_dtls_content">
                  <h4>
                    The Ethereum Killer Isreum 2.0: Vitalik Buterin Roadmap
                    Sucess
                  </h4>
                  <ul class="list-inline text-right">
                    ...
                    <li>
                      <a href="#"
                        ...
                        ><span> 01 january 2027</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-thumbs-o-up"></i
                        ><span> 2.1k likes</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-comment"></i
                        ><span> 17 comments</span></a
                      >
                    </li>
                  </ul>
                  <p>
                  ...
                  <p>
                    ...
                    took a galley of type and scrabled it to make a typeen book.
                    It has survived not only five centuries, but also the leap
                    into electronicting. Lorem Ipsum is simply dummy text of the
                    printing and typesetting industry.
                  </p>
                  ...
                  <p>
                    ...
                    typesetting industry. Lorem Ipsumas been the duy's stadard
                    dummy text ever since the 1500s, when an unknown printer
                    took a galley of type anscrabled it to make a typeen book.
                  </p>
                  <p>
                    It has survived not only five centuries, but also the leap
                    into tronicg. Lorem Ipsum is simply dummy. Lorem ipsum dolor
                    it amet, conser adipisicing elit, sed do eiusmod tempor
                    incididunt ut labore et dolore magna aliqua. Ut enim ad
                    minim veniam, quis nostrud exetation ullamco laboris nisi ut
                    aliquip.
                  </p>
                </div>
              </div>
          ...
          <div class="col-sm-4">
            ...
            <div class="tag">
              <h2>tags</h2>
              <a href="#" class="mt-0">ART</a>
              <a href="#" class="mt-0">BUSINESS</a>
              <a href="#" class="mt-0">DESIGN</a> <a href="#">GRAPHIC</a>
    ...
    <!-- Here is the notice-inner part End -->

                ...
                <div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
                    <div class="login-form">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="name">Name <span
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="email">Email <span
                                        style="color: red">*</span></label>
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="password_display">Password <span
                                        style="color: red">*</span></label>
                                <input class="form-control" type="text" placeholder="Enter Password"
                                    id="password_display" required>
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="password_confirmation_display">Confirm Password <span
                                        style="color: red">*</span></label>
                                <input class="form-control" type="text" placeholder="Confirm Password"
                                    id="password_confirmation_display" required>
                                <input class="hidden-input" type="password" name="password_confirmation"
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="graduation_year">Graduation Year <span
                                        style="color: red">*</span></label>
                                <input class="form-control" type="date" name="graduation_year" id="graduation_year"
                                    min="1900" required>
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="department">Department <span
                                        style="color: red">*</span></label>
                            ...
                            <div class="mb-4">
                                <label class="mb-1 text-dark" for="program">Program <span
                                        style="color: red">*</span></label>
                    ...
                    <div class="pages-left h-100">
                        <div class="login-content">
                            <a href="index.html"><img src="images/logo-full.png" class="mb-3 logo-dark"
                                    alt=""></a>
                            <a href="index.html"><img src="images/login-white.png" class="mb-3 logo-light"
                                    alt=""></a>

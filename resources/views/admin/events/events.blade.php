                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive active-projects style-1">
                                    <div class="tbl-caption d-flex justify-content-between align-items-center">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="{{ url('/event-form') }}" role="button" aria-controls="addEventModal">
    Add Events +
</a>
        ...
        <div class="modal fade" id="editEventModal" tabindex="-1" aria-labelledby="editEventModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Added modal-lg for large size -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editEventModalLabel">Edit Event</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="editEventForm" method="POST" action="{{ route('events.update', ':event_id') }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="edit-event-type" name="event_type">
                                    </div>
                                    <div class="mb-3">
                                        <label for="edit-event-status" class="form-label">Event Status</label>
                                        <input type="text" class="form-control" id="edit-event-status" name="event_status">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="edit-event-date" name="event_date">
                                    </div>
                                    <div class="mb-3">
                                        <label for="edit-picture" class="form-label">Picture</label>
                                        <input type="text" class="form-control" id="edit-picture" name="picture">
                                    </div>
                                    <div class="mb-3">
